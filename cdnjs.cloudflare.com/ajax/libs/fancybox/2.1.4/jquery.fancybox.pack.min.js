(function(e, t, n, i) {
    var r = n(e),
        ...
        h = function(e, t) {
            ...
            return t && p(e) && (n *= o.getViewport()[t] / 100), Math.ceil(n)
        },
        m = function(e, t) {
            return h(e, t) + "px"
        };
    n.extend(o, {
        ...
        jumpto: function(e, t, n) {
            var r = o.current;
            r && (e = h(e), o.direction = t || r.direction[e >= r.index ? "next" : "prev"], o.router = n || "jumpto", r.loop && (0 > e && (e = r.group.length + e % r.group.length), e %= r.group.length), r.group[e] !== i && (o.cancel(), o._start(e)))
        },
        ...
        bindEvents: function() {
            var e, t = o.current;
            t && (r.bind("orientationchange.fb" + (c ? "" : " resize.fb") + (t.autoCenter && !t.locked ? " scroll.fb" : ""), o.update), (e = t.keys) && a.bind("keydown.fb", function(r) {
                ...
                return 27 === a && o.coming ? !1 : (!(r.ctrlKey || r.altKey || r.shiftKey || r.metaKey || s && (s.type || n(s).is("[contenteditable]")) || !n.each(e, function(e, s) {
                    return t.group.length > 1 && s[a] !== i ? (o[e](s[a]), r.preventDefault(), !1) : n.inArray(a, s) > -1 ? (o[e](), r.preventDefault(), !1) : void 0
                })), void 0)
                ...
                0 !== i && !l && o.group.length > 1 && !t.canShrink && (a > 0 || r > 0 ? o.prev(a > 0 ? "down" : "left") : (0 > a || 0 > r) && o.next(0 > a ? "up" : "right"), e.preventDefault())
            }))
        },
        ...
        _start: function(e) {
            var t, i, r = {};
            if (e = h(e), t = o.group[e] || null, !t) return !1;
            if (r = n.extend(!0, {}, o.opts, t), t = r.margin, i = r.padding, "number" === n.type(t) && (r.margin = [t, t, t, t]), "number" === n.type(i) && (r.padding = [i, i, i, i]), r.modal && n.extend(!0, r, {
                    closeBtn: !1,
                    closeClick: !1,
                    nextClick: !1,
                    arrows: !1,
                ...
                }), r.autoSize && (r.autoWidth = r.autoHeight = !0), "auto" === r.width && (r.autoWidth = !0), "auto" === r.height && (r.autoHeight = !0), r.group = o.group, r.index = e, o.coming = r, !1 === o.trigger("beforeLoad")) o.coming = null;
            else {
                if (i = r.type, t = r.href, !i) return o.coming = null, o.current && o.router && "jumpto" !== o.router ? (o.current.index = e, o[o.router](o.direction)) : !1;
                if (o.isActive = !0, ("image" === i || "swf" === i) && (r.autoHeight = r.autoWidth = !1, r.scrolling = "visible"), "image" === i && (r.aspectRatio = !0), "iframe" === i && c && (r.scrolling = "scroll"), r.wrap = n(r.tpl.wrap).addClass("fancybox-" + (c ? "mobile" : "desktop") + " fancybox-type-" + i + " fancybox-tmp " + r.wrapCSS).appendTo(r.parent || "body"), n.extend(r, {
                    ...
                    if (!r.content || !r.content.length) return o._error("content")
        ...
        _afterLoad: function() {
            var e, t, i, r, a, s = o.coming,
                l = o.current;
            if (o.hideLoading(), s && !1 !== o.isActive)
                if (!1 === o.trigger("afterLoad", s, l)) s.wrap.stop(!0).trigger("onReset").remove(), o.coming = null;
                else {
                    switch (l && (o.trigger("beforeChange", l), l.wrap.stop(!0).removeClass("fancybox-opened").find(".fancybox-item, .fancybox-nav").remove()), o.unbindEvents(), e = s.content, t = s.type, i = s.scrolling, n.extend(o, {
                        wrap: s.wrap,
                        skin: s.skin,
                        outer: s.outer,
                        inner: s.inner,
        ...
        _setDimension: function() {
            var e, t, i, r, a, s, l, c, u, d = o.getViewport(),
                ...
                C = _.maxHeight,
                T = _.scrolling,
                S = _.scrollOutside ? _.scrollbarWidth : 0,
                A = _.margin,
                R = h(A[1] + A[3]),
                I = h(A[0] + A[2]);
            if (f.add(v).add(y).width("auto").height("auto").removeClass("fancybox-tmp"), A = h(v.outerWidth(!0) - v.width()), e = h(v.outerHeight(!0) - v.height()), t = R + A, i = I + e, r = p(b) ? (d.w - t) * h(b) / 100 : b, a = p(k) ? (d.h - i) * h(k) / 100 : k, "iframe" === _.type) {
                if (u = _.content, _.autoHeight && 1 === u.data("ready")) try {
                    u[0].contentWindow.document.location && (y.width(r).height(9999), s = u.contents().find("body"), S && s.css("overflow-x", "hidden"), a = s.height())
                } catch (D) {}
            } else(_.autoWidth || _.autoHeight) && (y.addClass("fancybox-tmp"), _.autoWidth || y.width(r), _.autoHeight || y.height(a), _.autoWidth && (r = y.width()), _.autoHeight && (a = y.height()), y.removeClass("fancybox-tmp"));
            if (b = h(r), k = h(a), c = r / a, w = h(p(w) ? h(w, "w") - t : w), E = h(p(E) ? h(E, "w") - t : E), x = h(p(x) ? h(x, "h") - i : x), C = h(p(C) ? h(C, "h") - i : C), s = E, l = C, _.fitToView && (E = Math.min(d.w - t, E), C = Math.min(d.h - i, C)), t = d.w - R, I = d.h - I, _.aspectRatio ? (b > E && (b = E, k = h(b / c)), k > C && (k = C, b = h(k * c)), w > b && (b = w, k = h(b / c)), x > k && (k = x, b = h(k * c))) : (b = Math.max(w, Math.min(b, E)), _.autoHeight && "iframe" !== _.type && (y.width(b), k = y.height()), k = Math.max(x, Math.min(k, C))), _.fitToView)
                if (y.width(b).height(k), f.width(b + A), d = f.width(), R = f.height(), _.aspectRatio)
                    for (;
                        (d > t || R > I) && b > w && k > x && !(g++ > 19);) k = Math.max(x, Math.min(C, k - 10)), b = h(k * c), w > b && (b = w, k = h(b / c)), b > E && (b = E, k = h(b / c)), y.width(b).height(k), f.width(b + A), d = f.width(), R = f.height();
                else b = Math.max(w, Math.min(b, b - (d - t))), k = Math.max(x, Math.min(k, k - (R - I)));
            S && "auto" === T && a > k && t > b + A + S && (b += S), y.width(b).height(k), f.width(b + A), d = f.width(), R = f.height(), f = (d > t || R > I) && b > w && k > x, b = _.aspectRatio ? s > b && l > k && r > b && a > k : (s > b || l > k) && (r > b || a > k), n.extend(_, {
                dim: {
                    width: m(d),
                    height: m(R)
                },
                ...
                wPadding: A,
                hPadding: e,
                wrapSpace: R - v.outerHeight(!0),
                skinSpace: v.height() - k
            }), !u && _.autoHeight && k > x && C > k && !b && y.height("auto")
        },
        _getPosition: function(e) {
            ...
            return t.autoCenter && t.fixed && !e && n.h >= a && n.w >= r ? i.position = "fixed" : t.locked || (i.top += n.y, i.left += n.x), i.top = m(Math.max(i.top, i.top + (n.h - a) * t.topRatio)), i.left = m(Math.max(i.left, i.left + (n.w - r) * t.leftRatio)), i
        },
        ...
        step: function(e, t) {
            ...
            var a = i.wrapSpace,
                s = i.skinSpace;
            ("width" === r || "height" === r) && (n = t.end === t.start ? 1 : (e - t.start) / (t.end - t.start), o.isClosing && (n = 1 - n), i = "width" === r ? i.wPadding : i.hPadding, i = e - i, o.skin[r](h("width" === r ? i : i - a * n)), o.inner[r](h("width" === r ? i : i - a * n - s * n)))
        },
        zoomIn: function() {
            var e = o.current,
                t = e.pos,
        ...
        changeIn: function() {
            var e, t = o.current,
                ...
                a = o.direction;
            i.opacity = .1, "elastic" === n && (e = "down" === a || "up" === a ? "top" : "left", "down" === a || "right" === a ? (i[e] = m(h(i[e]) - 200), r[e] = "+=200px") : (i[e] = m(h(i[e]) + 200), r[e] = "-=200px")), "none" === n ? o._afterZoomIn() : o.wrap.css(i).animate(r, {
        ...
        onReady: function(e, i) {
            n(".fancybox-overlay").stop(!0, !0), this.overlay || (this.margin = a.height() > r.height() || "scroll" === n("body").css("overflow-y") ? n("body").css("margin-right") : !1, this.el = t.all && !t.querySelector ? n("html") : n("body"), this.create(e)), e.locked && this.fixed && (i.locked = this.overlay.append(i.wrap), i.fixed = !1), !0 === e.showEarly && this.beforeShow.apply(this, arguments)
        },
            ...
            if (n.isFunction(i) && (i = i.call(t.element, t)), d(i) && "" !== n.trim(i)) {
                switch (t = n('<div class="fancybox-title fancybox-title-' + r + '-wrap">' + i + "</div>"), r) {
                    ...
                    case "over":
                        ...
                        break;
                    default:
                        r = o.skin, t.appendTo("body"), s && t.width(t.width()), t.wrapInner('<span class="child"></span>'), o.current.margin[2] += Math.abs(h(t.css("margin-bottom")))
                }
        ...
        var t, i = n(this),
            ...
            s = function(a) {
                var s, l, c = n(this).blur(),
                    u = t;
                !(a.ctrlKey || a.altKey || a.shiftKey || a.metaKey || c.is(".fancybox-wrap") || (s = e.groupAttr || "data-fancybox-group", l = c.attr(s), l || (s = "rel", l = c.get(0)[s]), l && "" !== l && "nofollow" !== l && (c = r.length ? n(r) : i, c = c.filter("[" + s + '="' + l + '"]'), u = c.index(this)), e.index = u, !1 === o.open(c, e) || !a.preventDefault()))
            };
        return e = e || {}, t = e.index || 0, r && !1 !== e.live ? a.undelegate(r, "click.fb-start").delegate(r + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", s) : i.unbind("click.fb-start").bind("click.fb-start", s), this.filter("[data-fancybox-start=1]").trigger("click"), this
    }, a.ready(function() {
