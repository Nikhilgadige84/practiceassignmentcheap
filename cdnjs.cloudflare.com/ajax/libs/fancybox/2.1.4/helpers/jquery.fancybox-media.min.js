(function(e) {
    ...
    t.helpers.media = {
        ...
        beforeLoad: function(t, i) {
            var r, a, o, s, l = i.href || "",
                c = !1;
            for (r in t)
                if (a = t[r], o = l.match(a.matcher)) {
                    c = a.type, s = e.extend(!0, {}, a.params, i[r] || (e.isPlainObject(t[r]) ? t[r].params : null)), l = "function" === e.type(a.url) ? a.url.call(this, o, s, i) : n(a.url, o, s);
                    break
                }
